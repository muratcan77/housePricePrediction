...
train = pd.read_csv("/Users/muratcanaltintas/Desktop/pythonProgramlam_3/python_for_data_science/ec_fiyat_tahmin/train.csv")
test = pd.read_csv("/Users/muratcanaltintas/Desktop/pythonProgramlam_3/python_for_data_science/ec_fiyat_tahmin/test.csv")
df = pd.concat([train, test], ignore_index=False).reset_index()
#ignore_index -> df veri çerçevesinin indeksi sıfırdan başlar.

df = df.drop("index", axis=1)

####### Veri Setini Tanımak İçin #######
...
#bağımlı değişkenin logaritmasını incelenmesi
